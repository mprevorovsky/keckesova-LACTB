...
#PEO4_vs_Primary
PEO4_in_Primary <- PEO4_DEG[which(rownames(PEO4_DEG)%in%rownames(Primary_DEG)),] #381 genes total
PEO4_in_Primary <- PEO4_in_Primary[order(PEO4_in_Primary$gene_name),]
Primary_in_PEO4 <- Primary_DEG[which(rownames(Primary_DEG)%in%rownames(PEO4_DEG)),]
...
* There are 13 intersections of PEO4 and OVCAR8, 65 of them are regulated in the same direction (this line is a subject to change after PEOvsPrimary and OVCARvsPrimary overlaps will be removed)
